...
c--- a set of routines that assign a pointer to a 4-byte integer for rank 0-7
      SUBROUTINE inshm_SegmentPtr_X_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(1), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(2), INTENT(IN) :: idims
      INTEGER(KIND=4), INTENT(IN) :: iverb
      INTEGER(KIND=4), INTENT(OUT) :: ier
      INTEGER(KIND=c_int) :: iv,ih
      ...
      SUBROUTINE inshm_SegmentPtr_XXX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(3), INTENT(IN) :: idims
      INTEGER(KIND=4), INTENT(IN) :: iverb
      INTEGER(KIND=4), INTENT(OUT) :: ier
      INTEGER(KIND=c_int) :: iv,ih
      ...
      SUBROUTINE inshm_SegmentPtr_XXXX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(4), INTENT(IN) :: idims
      INTEGER(KIND=4), INTENT(IN) :: iverb
      INTEGER(KIND=4), INTENT(OUT) :: ier
      INTEGER(KIND=c_int) :: iv,ih
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(6), INTENT(IN) :: idims
      INTEGER(KIND=4), INTENT(IN) :: iverb
      INTEGER(KIND=4), INTENT(OUT) :: ier
      INTEGER(KIND=c_int) :: iv,ih
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXXX_INT4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=4), DIMENSION(:,:,:,:,:,:,:), POINTER, INTENT(OUT) ::data_ptr
      INTEGER(KIND=4), dimension(7), INTENT(IN) :: idims
      INTEGER(KIND=4), INTENT(IN) :: iverb
      INTEGER(KIND=4), INTENT(OUT) :: ier
      INTEGER(KIND=c_int) :: iv,ih
...
c--- a set of routines that assign a pointer to a 8-byte integer for rank 0-7
      SUBROUTINE inshm_SegmentPtr_X_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      ...
      SUBROUTINE inshm_SegmentPtr_XX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(2), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(3), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(4), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(5), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(6), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXXX_INT8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      INTEGER(KIND=8), DIMENSION(:,:,:,:,:,:,:), POINTER, INTENT(OUT) ::data_ptr
      INTEGER(KIND=4), dimension(7), INTENT(IN) :: idims
...
c--- a set of routines that assign a pointer to a 4-byte real for rank 0-7
      SUBROUTINE inshm_SegmentPtr_X_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      ...
      SUBROUTINE inshm_SegmentPtr_XX_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=4), DIMENSION(:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(2), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXX_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=4), DIMENSION(:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(3), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXX_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=4), DIMENSION(:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(4), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXX_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=4), DIMENSION(:,:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(6), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXXX_REAL4( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=4), DIMENSION(:,:,:,:,:,:,:), POINTER, INTENT(OUT) ::data_ptr
      INTEGER(KIND=4), dimension(7), INTENT(IN) :: idims
...
c--- a set of routines that assign a pointer to a 8-byte real for rank 0-7
      SUBROUTINE inshm_SegmentPtr_X_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      ...
      SUBROUTINE inshm_SegmentPtr_XX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(2), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(3), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(4), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(5), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:,:,:,:,:), POINTER, INTENT(OUT) :: data_ptr
      INTEGER(KIND=4), dimension(6), INTENT(IN) :: idims
      ...
      SUBROUTINE inshm_SegmentPtr_XXXXXXX_REAL8( handle, data_ptr, idims, iverb, ier )
      Implicit None
      INTEGER(KIND=4), INTENT(IN) :: handle
      REAL   (KIND=8), DIMENSION(:,:,:,:,:,:,:), POINTER, INTENT(OUT) ::data_ptr
      INTEGER(KIND=4), dimension(7), INTENT(IN) :: idims
